...
![Horse populations for the province with the largest standard deviation](../results/horse_pops_plot_largest_sd.png){width=70% #fig-2}

<!-- Not sure why figure 2 keeps rendering between references without the additon of a line right here -->

In @fig-2,

we zoom in and look at the province of `{python} largest_sd`, 
